  ...
  return (
    <section className="py-20 px-6 bg-gray-200">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-12">Vision & Mission</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-6 shadow-md">
            ...
            <p className="text-gray-600">
              To become a leading air freight company that delivers fast, secure, and
              reliable services at national and international levels.
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-md">
            ...
            <ul className="text-gray-600 list-disc pl-5 space-y-2">
              <li>Deliver fast and efficient shipping services</li>
